      ...
      <Container>
        ...
        <Grid container spacing={2}>
          <Grid item xs={12} md={6}>
            ...
            <Button variant="contained"  color="primary" href="https://drive.google.com/file/d/1_79wgeu8LgQdGzuY240T325XZKDWTXry/view?usp=sharing" style={{ backgroundColor: '#6002E0', color: 'white', float: 'left' }} target="_blank">
              Resume Ready!
            </Button>
          </Grid>

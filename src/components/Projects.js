...
const Projects = () => {
  ...
  return (
    <section id='project-section' className="projects-container">
      <Container>
        <Typography variant="h4"  style={{color: '#03DAC5', marginBottom: '0.rem'}}>My Projects</Typography>
        <Grid container spacing={2}>
          <Grid item xs={12} sm={6} md={4}>
            <Card  className="project-card" style={{ borderRadius: '8px' }}>
              ...
              />
             <CardContent style={{ backgroundColor: '#4F4557', textAlign: 'left', paddingLeft: '4rem' }}>
              <Typography variant="h4" style={{ color: 'white' }}>{projects[0].title}</Typography>
              <Typography variant="body1" className="project-description" style={{ color: 'white', marginBottom: '0.9rem', textAlign: 'left' }}>
                {projects[0].description}
              </Typography>
              <Button variant="contained" href={projects[0].githubLink} style={{ backgroundColor: '#6002E0' }} target="_blank">
                View on GitHub
              </Button>
            </CardContent>
            </Card>
        ...
        <Card  className="project-card" style={{ borderRadius: '8px' }}>
            ...
            />
            <CardContent style={{ backgroundColor: '#4F4557', textAlign: 'left', paddingLeft: '4rem' }}>
              <Typography variant="h4" style={{ color: 'white' }}>{projects[1].title}</Typography>
              <Typography variant="body1" className="project-description" style={{ color: 'white', marginBottom: '0.9rem', textAlign: 'left' }}>
          ...
          <Card  className="project-card" style={{ borderRadius: '8px' }}>
            ...
            />
            <CardContent style={{ backgroundColor: '#4F4557', textAlign: 'left',paddingLeft: '4rem'  }}>
  <Typography variant="h4" style={{ color: 'white' }}>{projects[2].title}</Typography>
  <Typography variant="body1" className="project-description" style={{ color: 'white', marginBottom: '0.9rem', textAlign: 'left' }}>
